  ...
  return (
    <div style={styles.wrapper}>
      <div style={styles.card}>
        <h2 style={{ marginTop: 0, color: colors.accentDark }}>Patient Login</h2>
        <p style={{ color: colors.textMuted, fontSize: 13 }}>
          Access your ECG analyses and CVD risk history.
        </p>
        ...
        <p style={{ fontSize: 13, color: colors.textMuted, marginTop: 16, textAlign: 'center' }}>
          New patient? <Link to="/patient/signup" style={{ color: colors.accentDark, fontWeight: 600 }}>Sign up</Link>
        </p>
        <p style={{ fontSize: 12, color: colors.textLight, marginTop: 8, textAlign: 'center' }}>
          Demo: <code style={styles.code}>eric.test@example.com</code> / <code style={styles.code}>patient123</code>
        </p>
      </div>
    </div>
  );
